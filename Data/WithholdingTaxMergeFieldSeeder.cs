...
namespace MyApp.Api.Data
{
    ...
    /// <see cref="SalesMergeFieldSeeder"/> records: the Bill and TaxInvoice
    ...
    /// one that would rather hide the row entirely, matching how the other
    /// conditional merge fields already behave.
    /// </summary>
