...
already-used number, a zero and the FBR Sandbox's reserved 900000+ band each say
so in plain words and block Save, and a free one confirms what the document will
print. The
