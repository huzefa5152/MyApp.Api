---
name: myapp-print-templates
description: Match MyApp.Api Trader print templates to user PDFs, images, and layout requirements using only the merge fields of the TraderFbrInvoicingSystem production branch. Covers professional pagination and configurable signatures. Does not apply to other production variants.
---

# MyApp Trader print templates

This skill is exclusively for `TraderFbrInvoicingSystem`. Do not apply its merge fields or layouts to the other production branches. The usual project is `D:/huzefa-portfolio/github-projects/MyApp.Api`; locate the actual checkout and read its `AGENTS.md` and `docs/ENVIRONMENTS.md` first.
