---
name: myapp-master-print-templates
description: Match MyApp.Api Master print templates to user PDFs, images, and layout requirements using only the merge fields of the master production branch. Covers professional pagination and configurable signatures. Does not apply to other production variants.
---

# MyApp Master print templates

This skill is exclusively for `master`. Do not apply its merge fields or layouts to the other production branches. The usual project is `D:/huzefa-portfolio/github-projects/MyApp.Api`; locate the actual checkout and read its `AGENTS.md` and `docs/ENVIRONMENTS.md` first.
