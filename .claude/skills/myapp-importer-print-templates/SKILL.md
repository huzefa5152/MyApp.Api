---
name: myapp-importer-print-templates
description: Match MyApp.Api Importer print templates to user PDFs, images, and layout requirements using only the merge fields of the feat/importer-ledger-receipts production branch. Covers professional pagination and configurable signatures. Does not apply to other production variants.
---

# MyApp Importer print templates

This skill is exclusively for `feat/importer-ledger-receipts`. Do not apply its merge fields or layouts to the other production branches. The usual project is `D:/huzefa-portfolio/github-projects/MyApp.Api`; locate the actual checkout and read its `AGENTS.md` and `docs/ENVIRONMENTS.md` first.
