...
namespace MyApp.Api.Migrations
{
    ...
    [Migration("20260511184131_AddInvoiceItemAdjustments")]
    partial class AddInvoiceItemAdjustments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyApp.Api.Models.InvoiceItemAdjustment", b =>
                {
                    ...
                    b.HasIndex("InvoiceItemId1")
                        .IsUnique()
                        .HasFilter("[InvoiceItemId1] IS NOT NULL");
            ...
            modelBuilder.Entity("MyApp.Api.Models.InvoiceItemAdjustment", b =>
                {
                    ...
                    b.HasOne("MyApp.Api.Models.InvoiceItem", null)
                        .WithOne("Adjustment")
                        .HasForeignKey("MyApp.Api.Models.InvoiceItemAdjustment", "InvoiceItemId1");
