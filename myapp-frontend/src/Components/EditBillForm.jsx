...
export default function EditBillForm({ invoiceId, onClose, onSaved }) {
  ...
  const handleSave = async (e) => {
    ...
    if (items.some((i) => !i.uom?.trim())) return setError("All items must have a UOM.");
                  ...
                  <table style={styles.table}>
                    <thead>
                      <tr style={styles.thead}>
                        <th style={{ ...styles.th, width: "26%" }}>Description</th>
                        <th style={{ ...styles.th, width: "8%" }}>Qty</th>
                        <th style={{ ...styles.th, width: "10%" }}>UOM</th>
                        <th style={{ ...styles.th, width: "11%" }}>Unit Price</th>
                        <th style={{ ...styles.th, width: "12%" }}>Line Total</th>
                        <th style={{ ...styles.th, width: "11%" }}>HS Code</th>
                        <th style={{ ...styles.th, width: "22%" }}>Sale Type</th>
                      </tr>
                    </thead>
                    <tbody>
                      {items.map((item, idx) => (
