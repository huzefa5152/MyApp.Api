...
const st = {
  ...
  select: { minHeight: 44, flex: 1, minWidth: 120, maxWidth: 220, padding: "0.3rem 0.4rem", fontSize: "0.8rem", borderRadius: 7, border: "1px solid #d0d7e2", background: "#fff" },
  inlineThumb: { width: 30, height: 24, objectFit: "contain", border: "1px solid #e8edf3", borderRadius: 4, background: "#fff", flexShrink: 0 },
  linkBtn: { minHeight: 44, display: "inline-flex", alignItems: "center", gap: "0.3rem", padding: "0.25rem 0.5rem", fontSize: "0.76rem", borderRadius: 7, border: "1px solid #d0d7e2", background: "#fff", color: "#0d47a1", cursor: "pointer" },
  cards: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(110px, 100%), 1fr))", gap: "0.5rem" },
  card: { minHeight: 44, display: "flex", flexDirection: "column", alignItems: "center", gap: "0.3rem", padding: "0.5rem", borderRadius: 8, border: "1px solid #d0d7e2", background: "#fff", cursor: "pointer", boxShadow: "none" },
