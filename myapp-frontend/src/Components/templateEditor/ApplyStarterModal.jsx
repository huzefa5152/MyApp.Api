 ...
 * The template id, scope, default flag and audit history are always kept.
 *
 * Props: template (DTO: id, name, templateType, htmlContent, divisionName?),
      ...
      <div style={s.modal} onClick={(e) => e.stopPropagation()}>
        <div style={s.header}>
          <div style={{ minWidth: 0 }}>
            ...
            <p style={s.subtitle}>
              {TEMPLATE_TYPE_LABEL[template.templateType] || template.templateType}
        ...
        <div style={s.modes}>
          ...
          <label style={{ ...s.mode, ...(mode === "all" ? s.modeActive : {}) }}>
            ...
            <div>
              ...
              <div style={s.modeDesc}>Also discards the visual-editor layout so the starter fully replaces the current design. Name, scope, default &amp; history are still kept.</div>
            </div>
          </label>
        </div>
