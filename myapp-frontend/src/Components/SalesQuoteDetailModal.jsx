...
// Read-only view of a Sales Quote: header + meta + items + totals + notes, plus
// its attachments in view mode (preview / download only). Mirrors the
// SalesOrderDetailModal pattern.
      ...
      <div style={{ ...formStyles.modal, maxWidth: `${modalSizes.lg}px` }} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={formStyles.body}>
          ...
          <div style={st.metaGrid}>
            ...
            <Meta label="Division" value={quote.divisionName || "—"} />
