export const lineSources = {
  ...
  purchaseDebit: { label: "Purchase Debit Notes", path: "purchasedebitnotes", permission: "purchasedebitnotes.list.view", number: "debitNoteNumber", date: "date", party: "supplierName" },
...
export const lineColumns = [
  ...
  ["division", "Division"], ["status", "Status"], ["salesOrder", "Sales Order #"],
