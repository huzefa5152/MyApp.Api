 ...
 * companyNTN, companySTRN, divisionName, reference, date, contactType, contactName,
...
.division { font-size: 11px; color: #444; letter-spacing: 1px; margin-top: 2px; }
...
.division { font-size: 10px; color: #777; margin-top: 2px; }
...
.hb-division { font-size: 10px; opacity: 0.85; margin-top: 2px; }
...
.division { font-size: 9px; margin-top: 2px; }
