 ...
 * (e.g. the Sales Quote "header banner" templates) has ZERO intrinsic height
 * until its bytes arrive, so it lays out at 0px and prints blank — while the
 * surrounding text appears, because text lays out synchronously. Confirmed on
 * the Jorbai Sales Quote bug (2026-06-27): the banner measured 0px at
 * immediate-print and 133px once the image loaded.
 *
