...
| 2 | Print Template — multi-doc, Company-level | ✅ done (commit fa9e4af) |
| 3 | Receipt (Accounting), GL-stripped, both directions | ✅ CODE-COMPLETE + VERIFIED (uncommitted, awaiting commit + merge permission) |
