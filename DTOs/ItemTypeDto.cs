namespace MyApp.Api.DTOs
{
    public class ItemTypeDto
    {
        ...
        /// <summary>
        /// True when the HS tariff import minted this row. READ-ONLY: create
        /// and update ignore it, because it records who made the row, not
        /// something an operator can choose. The catalog list badges it so a
        /// placeholder is recognisable now that everything shares one list.
        /// </summary>
