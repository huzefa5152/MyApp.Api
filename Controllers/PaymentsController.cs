...
namespace MyApp.Api.Controllers
{
    ...
    /// subledger. Receipts and payments are deliberately split into separate
    /// routes + permissions (separation of duties: a cashier may record receipts
    /// without being able to pay money out). Direction is fixed by the route,
