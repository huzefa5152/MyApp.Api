...
namespace MyApp.Api.Controllers
{
    ...
    public class ItemTypesController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<ItemTypeDto>>> GetAll(
            ...
            [FromQuery] bool includeAutoGenerated = false,
            [FromQuery] string? search = null,
            [FromQuery] int? take = null)
        {
            // HS-import placeholders are excluded unless explicitly requested
            // (2026-08-30). A tariff import mints one per code — ~7.8k today —
            // and this endpoint feeds both the Item Catalog page and every
            // document picker, neither of which pages its rows. Asking for them
            // is capped so "show placeholders" can never return the whole table.
            if (includeAutoGenerated) take = take is > 0 and <= 500 ? take : 200;
