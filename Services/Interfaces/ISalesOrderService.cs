...
namespace MyApp.Api.Services.Interfaces
{
    public interface ISalesOrderService
    {
        ...
        /// <summary>
        /// Unlinked, unbilled, non-cancelled challans for this order's client —
        /// candidates for attaching to the order (e.g. No-PO challans raised
        /// before the PO arrived). Empty when the order doesn't exist.
        /// </summary>
        ...
        /// now fully delivered. Records NO stock movement — the challan's stock was
        /// already booked at its creation. Returns the updated order, or null when
